...
public class CommunityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 해더 설정
        HeaderView headerView = new HeaderView(findViewById(R.id.header_layout), "커뮤니티 보안사항");
        // 뒤로가기 버튼 클릭 리스너 설정
        ...
        List<Item> itemList = JsonAdapter.parseJsonToItemList(this, "communityData.json");
